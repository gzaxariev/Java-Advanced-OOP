...
public class CarManagerImpl implements CarManager {
    ...
    private static final String SHOW_CAR_TYPE = "Snow";
    ...
    @Override
    public void register(int id, String type,
                         String brand, String model, int yearOfProduction, int horsepower, int acceleration,
