...
public class Human {
    private static final String INVALID_FIRST_NAME_FORMAT =
            "Expected upper case letter!Argument: firstName";
    private static final String INVALID_FIRST_NAME_LENGTH =
            "Expected length at least 4 symbols!Argument: firstName";
    private static final String INVALID_LAST_NAME_FORMAT =
            "Expected upper case letter!Argument: lastName";
    private static final String INVALID_LAST_NAME_LENGTH =
    ...
    public void setFirstName(String firstName) {
        ...
        if (!Character.isUpperCase(firstName.charAt(0))){
            throw new IllegalArgumentException(INVALID_FIRST_NAME_FORMAT);
    ...
    protected void setLastName(String lastName) {
        if (!Character.isUpperCase(lastName.charAt(0))){
            throw new IllegalArgumentException(INVALID_LAST_NAME_FORMAT);
