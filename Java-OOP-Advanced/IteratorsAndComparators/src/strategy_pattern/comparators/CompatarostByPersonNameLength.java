...
public class CompatarostByPersonNameLength implements Comparator<Person> {
    @Override
    public int compare(Person person1, Person person2) {
        ...
        return String.valueOf(person1.getName().charAt(0)).compareToIgnoreCase(String.valueOf(person2.getName()
                .charAt(0)));
    }
}
